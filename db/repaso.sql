...
(
    id              bigserial constraint pk_disp primary key,
    ...
    aula_id         bigint  constraint fk_dispositivos_aulas
        ...
        constraint ck_lugar_valido check
            ((ordenador_id is null and aula_id is not null) or
             (ordenador_id is not null and aula_id is null))
);
